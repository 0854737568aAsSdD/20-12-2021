...
$(document).ready(function () {
    ...
    $("#myInput").on("keyup", function () {
        ...
        $("#myList").attr('style', "display:block; position: absolute;")
        if ($(this).val() == "") {
    ...
    function kiemtrae() {
        ...
        if(liTK.indexOf(email.val()) > -1){
            email.attr("class","form-control alert-danger")
    ...
    function kiemtramk() {
        ...
        if (!re.test(matK.val())) {
            matK.attr("class","form-control alert-danger")
            tbMK.html("Mật khẩu không chứa kí tự đặc biệt và ít nhất 6 kí tự")
            return false;
        }
    ...
    $("#save").on("click", function () {              
        ...
        if (check.length <= 0) {
            tbC.html("chấp nhận điều khoản")
            return false;
        }
        if (!kiemtraten() || !kiemtrasdt() || !kiemtradc() || !kiemtrae() || !kiemtrae() || !kiemtrarmk()) {
        ...
        $("#tc h3").html("Bạn đã đăng ký thành công")
        $("#tc").modal()
        return true;
    })
	...
	<div class="container-fluid">
		<nav class="navbar navbar-expand-sm bg-dark justify-content-center"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><span><a href="Html/Login.html">Đăng
							nhập </a></span></li>
			</ul>
		...
		<section>
			...
			<a href=""><img src="hinh/fb.png"></a> <a
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="DangKy" enctype="multipart/form-data">
						<div class="form-group">
							<div class="text-danger" id="thongbao" style="text-align: center"></div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-6">
								<label for="ten">Họ tên</label> <input type="text"
									class="form-control" id="ten" placeholder="Nhập tên" name="HoTen"> <span
									id="tbTen" class="text-danger" name="hoten">*</span>
							</div>
							<div class="form-group col-md-6">
								<label for="soDT">Số điện thoại</label> <input type="text"
									class="form-control" id="soDT" placeholder="Nhập số điện thoại" name="SoDienThoai">
								<span id="tbSDT" class="text-danger" >*</span>
							</div>
						</div>
						<div class="form-group">
							<label for="diaC">Địa chỉ</label> <input type="text"
								class="form-control" id="diaC" placeholder="Nhập địa chỉ" name="DiaChi">
							<span id="tbDC" class="text-danger" name="diachi">*</span>
						</div>
						<div class="form-group">
							<label for="email">Tài Khoản</label> <input type="email"
								class="form-control" id="email" placeholder="Nhập địa chỉ email" name="TenDangNhap">
							<span id="tbE" class="text-danger" >*</span>
						</div>
						<div class="form-row">
							<div class="form-group col-md-6">
								<label for="matK">Mật khẩu</label> <input type="password"
									class="form-control" id="matK" placeholder="Nhập mật khẩu" name="MatKhau">
								<span id="tbMK" class="text-danger">*</span>
							</div>
							<div class="form-group col-md-6">
